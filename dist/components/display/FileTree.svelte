<script lang="ts" module>import Folder from "@material-symbols/svg-400/rounded/folder.svg?icon";
...
function getIconForFile(filenameOrPath) {
...
<script lang="ts">const { content, class: customClass, ...rest } = $props();
</script>
